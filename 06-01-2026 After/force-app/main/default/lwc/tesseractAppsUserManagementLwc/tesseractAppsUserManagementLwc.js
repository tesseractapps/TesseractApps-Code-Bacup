...
export default class TesseractAppsUserManagement extends LightningElement {
    ...
    handleDownloadTemplate(event){
        ...
        if(this.typeOfUser=='NDIS'){
            const fileUrl = '/resource/Bulk_Upload_For_NDIS_User';
    ...
    handleUploadFinished(event) {
        ...
        /* =================================================
        🔥 STEP 6: CLEAR FILE INPUT (AFTER USING FILE)
    ...
    parseCSV(data) {
        ...
        let requiredHeaders = [
            ...
            'AddressState', 'AdressPostCode', 'AddressCountry', 'ManagementFee', 'Frequency'
        ];
        ...
        if (this.typeOfUser === 'NDIS') {
            ...
            for (let record of parsedData) {
                ...
                if (record.Role === 'Org Admin' &&
                    ...
                    record.UserType !== 'Facility Admin') {
                    this.dispatchEvent(
                        new ShowToastEvent({
