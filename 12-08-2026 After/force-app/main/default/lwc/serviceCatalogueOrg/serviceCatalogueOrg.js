...
export default class ServiceCatalogueOrg extends LightningElement {
    ...
    cancelAddServiceTypeFlag() {
       ...
       // this.isCloneCatalogue = false;
        console.log('cancelAddServiceTypeFlag - isCloneCatalogue:', this.isCloneCatalogue);
    ...
    loadServiceCatalogues() {
        console.log('loadServiceCatalogues - isCloneCatalogue:', this.isCloneCatalogue);
        ...
        .then(data => {
           ...
           // console.log('Saved Service Catalogues Length :', data.length);
            ...
            console.log('isCloneCatalogue:', this.isCloneCatalogue);
            console.log('expandedGroupKey:', this.expandedGroupKey);
           
            // if (this.isCloneCatalogue) {
            //     groupedMap.forEach(parent => {
            //         parent.isExpanded = parent.id === this.expandedGroupKey;
            //     });
            // }
            groupedMap.forEach(parent => {
                ...
                console.log(
                    'Parent Id before :',
                    parent.id,
                    '| Stored expandedGroupKey:',
                    this.expandedGroupKey,
                    '| Match:',
                    parent.id === this.expandedGroupKey
                );
    ...
    toggleExpand(event) {
        ...
        console.log(
            'After Toggle:',
            this.records.find(r => r.id === groupName)
        );
    ...
    handleCloneNDISSupportCat(event) {
        ...
        this.expandedGroupKey = selectedParent.id;
        console.log('this.expandedGroupKey :',this.expandedGroupKey);
