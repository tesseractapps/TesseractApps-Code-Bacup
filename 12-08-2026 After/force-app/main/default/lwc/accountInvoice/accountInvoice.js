...
export default class AccountInvoice extends LightningElement {
    ...
    @track allStatusOptions =[{label:'Draft',value:'Draft'},{label:'Issued',value:'Issued'},{label:'Paid',value:'Paid'},{label:'Unpaid',value:'Unpaid'} ];    //   ,{label:'Reversed',value:'Reversed'},{label:'Received',value:'Received'}
    @track taxCodes = [
...
clean(value) {
    ...
    // doc.text("Invoice Number", 150, 24);
        doc.text("TAX  INVOICE", 160, invoiceHeaderY);
        doc.setFont("Roboto-Bold", "bold");
        doc.setFontSize(12);
        doc.text(invoice.Invoice_No__c, 160,  invoiceHeaderY + 5);
        ...
        doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
        doc.setFontSize(10);
        doc.text("Date Issued: "+newDate, 160,  invoiceHeaderY + 10);
        doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
        doc.setFontSize(10);
        ...
        doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
        doc.setFontSize(10);
        doc.text("Due Date: "+newDate1, 160, invoiceHeaderY + 15);
        doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
        doc.setFontSize(10);
       ...
       : invoice.Accounting_Journal_Entry__r[0].Entity_Profile__r.First_Name__c + " " + invoice.Accounting_Journal_Entry__r[0].Entity_Profile__r.Last_Name__c ), 10, taxInvoiceY);
    ...
    this.salesEntry = {
       ...
       // this.selectedAmount=0;
        ...
        this.allStatusOptions =[{label:'Draft',value:'Draft'},{label:'Issued',value:'Issued'},{label:'Paid',value:'Paid'},{label:'Unpaid',value:'Unpaid'}]; 
        this.statusOptions = [...this.allStatusOptions]; 
    }
    ...
    handleInvoicFlag() {
        ...
        this.isSalesFlag = false;
        this.isSalesTableFlag =false;
       // console.log('allStatusOptions.. IN handleInvoicFlag ', JSON.stringify(this.allStatusOptions));
        //console.log('statusOptions.. IN handleInvoicFlag ', JSON.stringify(this.statusOptions));
        this.allStatusOptions =[{label:'Draft',value:'Draft'},{label:'Issued',value:'Issued'}]; 
        this.statusOptions = [...this.allStatusOptions]; 
               ...
               let invoiceType = '';
                if (invoice.Is_Service_Invoice__c) {
                    ...
                    this.isParticipantInvoice=true;
                     this.isInvoiceFromIct = false;
                } else if (invoice.ICT_Invoice_Entry__c) {
                    invoiceType = 'ICT';
                    this.isInvoiceFromIct = true;
    ...
    handleCreditnote(event) {
        ...
        console.log(' this.selectedStatus 11 ', this.selectedStatus);
        ///  ADDED FOR  CREDIT NOTE  STATUS ISSUE 
        this.selectedStatus= 'Reversed';
        console.log(' this.selectedStatus 22 ', this.selectedStatus);
       ...
       // this.statusOptions = [ { label: 'Reversed', value: 'Reversed' } ];
        ...
        console.log(' this.selectedStatus 33 ', this.selectedStatus);
        ...
        getAccountingInvoiceInEdit({ invoiceId: this.currentInvoiceId })
            .then(result => {
                ...
                if (result && result[0]) {
                    ...
                    // if (invoice.ICT_Invoice_Entry__c === true) {
                    //     console.log('isServices');
                    //     this.isRFQ = false;
                    //     this.isParticipantInvoice=false;
                    //     this.isInvoiceFromIct=true;
                ...
                // refreshApex(this.wiredEntityProfilesResult);
                    ...
                    console.log(' this.selectedStatus 44 ', this.selectedStatus);
                    if(this.selectedStatus =='Issued'){
                   ...
                   // } else if (this.selectedStatus === 'Received') {
                    ...
                    console.log(' this.selectedStatus 55 ', this.selectedStatus);
            ...
            .then(result => {
                ...
                if (result && result[0]) {
                    ...
                    if (invoice.Is_Service_Invoice__c === true) {
                        ...
                        // this.participantID = invoice.Participant__c;
                         //this.ServicesList = invoice.Services_Id_List__c;
                    }
                    if (invoice.ICT_Invoice_Entry__c === true) {
                        console.log('isICT');
                        this.isRFQ = false;
                ...
                // refreshApex(this.wiredEntityProfilesResult);
                    this.salesEntry = {
                        ...
                        participantID:invoice.Participant__c || '',
                        ServicesList:invoice.Services_Id_List__c || ''
...
showToast(title, message, variant) {
    ...
    async processSaveOrSubmit() {
        ...
        console.log('this.isInvoiceFromIct: ',this.isInvoiceFromIct);
        ...
        try {
            ...
            const result = await saveUpdateRfqInvoice({
                ...
                isInvoiceFromIct:this.isInvoiceFromIct
            });
           ...
           console.log('invoice status ',this.invRecords[0].Status__c);
            ...
            this.readInvoiceDetails();
            console.log('allStatusOptions.. IN submit ', JSON.stringify(this.allStatusOptions));
            console.log('statusOptions.. IN submit ', JSON.stringify(this.statusOptions));
            ...
            this.showToast('Error', error.body?.message || 'Invoice PDF generation failed.', 'error');
        }
    }
    HandleRFQ(event){
        // Handle toggle input
