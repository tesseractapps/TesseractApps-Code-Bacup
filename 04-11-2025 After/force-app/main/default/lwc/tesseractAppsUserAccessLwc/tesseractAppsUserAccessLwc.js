...
export default class TesseractAppsUserAccessLwc extends LightningElement {
    ...
    wiredUserAccessDetails(result) {
        this.wiredUserAccessDetailsResult = result; // store for refresh
        ...
        if (data) {
            ...
            getCurrentLoggedUserInfo()
                .then((userInfo) => {
                    ...
                    console.log('👤 Current Logged-in User Type:', this.userTypevalueforcurrentlogin);
                    ...
                    console.log('✅ Processed User Data Count:', this.totalRecords);
   ...
   @wire(getUserTypeValuesfromOrg, { selectedroleValue: '$selectedRole', userId: '$userId' })
    ...
    handlesavebutton(event) {
        ...
        const userData = {
            ...
            status: this.editstatus,  // ✅ Else, retain the old value
