...
export default class TesseractAppsProfitAndLossChartsLwc  extends LightningElement {
  ...
  /*   initializeChart() {
    ...
    initializeChart() {
        ...
        // ✅ AUD currency formatter
        const dollarAUFormatter = new Intl.NumberFormat('en-AU', {
            style: 'currency',
            currency: 'AUD',
        ...
        try {
            ...
            if (this.totalProfitLoss < 0) {
                rotationValue = 0;  // Loss at the bottom
                circumferenceValue = Math.PI;
            }
            ...
            this.chartInstance = new Chart(context, {
                ...
                options: {
                    responsive: true,
                    cutoutPercentage: 40, // v2 uses cutoutPercentage, not 'cutout'
                   ...
                   tooltips: {
                        callbacks: {
                            label: function(tooltipItem, data) {
                                ...
                                return `${label}: ${dollarAUFormatter.format(value)}`;
                            }
                        }
                    }
                }
