...
export default class FormRender extends LightningElement {
            ...
            if (cell.id === cellId) {
              const updatedCell = {
                ...
                field: {
                  ...
                  fileName: names.join(", "),
                  contentType:
                    files.length === 1 ? types[0] || null : "multiple",
                  s3Key: s3Keys,
                  urls,
                  meta: metaPayload
                }
  ...
  //           value = "Image attached below"; // keep the table tidy
  //         } else {
  //           value = ""; // or a short note
  //         }
  //       } else {
  //         value = item.value || "";
  //       }
  ...
  //       if (y + 40 > pageHeight) { doc.addPage(); y = 10; }
  //       doc.setFontSize(12);
  //       doc.text(img.label, 14, y);
  //       y += 5;
  //       doc.addImage(dataUrl, format, 14, y, 50, 30); // format = "PNG" | "JPEG"
  //       y += 40;
  //     } catch (error) {
