...
handleTsign(event) {
  ...
  const serviceAgreementId = event.currentTarget.dataset.id;
  const signatureUrl = event.currentTarget.dataset.signatureUrl;

  console.log("📌 AWS URL sent to Tsign:", tsignDocumentUrl);
  console.log("📌 Service Agreement ID sent to Tsign:", serviceAgreementId);
  ...
  const message = {
    source: "SERVICE",
    tsignreUrl: tsignDocumentUrl,
    serviceId: serviceAgreementId,
    quoteId: null,

    // ✅ legacy support (optional)
    recordId: serviceAgreementId
  };
