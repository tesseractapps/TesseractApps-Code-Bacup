...
this.updateStepVisibleRows?.();
  ...
  console.log("🔥 getFormattedValue:", cell.field?.dataType);
  ...
  // ✅ Checkbox
  if (cell.isCheckboxField || dataType === "checkbox field") {
  ...
  if (cell.isDropdownField && cell.isMultiSelect) {
    ...
    if (typeof cell.selectedValues === "string") {
      return cell.selectedValues;
    }
    return "—";
  }

// ✅ Single dropdown (FIXED)
if (cell.isDropdownField || cell.field?.isDropdown) {

  console.log("🟢 DROPDOWN BLOCK HIT");
  console.log("value:", cell.field?.value);
  console.log("displayValue:", cell.field?.displayValue);

  // lookup / predefined list (YOUR CASE)
  if (cell.field?.displayValue) {
    console.log("✔ Using displayValue");
    return cell.field.displayValue;
  }
  ...
  if (dataType === "date field") {
    ...
    console.group("📅 Date Field Formatting");
    console.log("Raw:", cell.field.value);

    const formatted = this.formatDateDD(cell.field.value);
  ...
  // ✅ Default fallback
  return cell.field.value != null
    ? String(cell.field.value)
    : "—";
}
...
handleDownloadCsv() {
  ...
  //     this.paginatedFormResponses =
  //         this.filteredFormResponses.slice(start, end);
