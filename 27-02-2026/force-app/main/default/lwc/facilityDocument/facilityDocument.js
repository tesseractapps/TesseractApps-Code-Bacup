...
export default class FacilityDocument extends LightningElement {
    ...
    set facilityId(value) {
        console.group('🏥 facilityId SETTER TRIGGERED');
        console.log('Incoming facilityId:', value);
        console.log('Previous facilityId:', this._facilityId);
        console.groupEnd();
...
handleEdit(e) {
    ...
    saveDocument() {
        ...
        // 3️⃣ Points Required
        // if (!this.editingDoc.points || this.editingDoc.points.trim() === '') {
