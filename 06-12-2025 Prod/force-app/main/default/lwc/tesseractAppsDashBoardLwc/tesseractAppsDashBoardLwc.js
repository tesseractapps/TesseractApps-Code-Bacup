...
`;
      ...
      if (tag === "input" || tag === "textarea") return;
        ...
        switch (true) {
            ...
            case event.altKey && event.key.toLowerCase() === "g":
                ...
                break;
            case event.altKey && event.key.toLowerCase() === "k":
  ...
  triggerShortcut(field, content) {
      ...
      // ✅ Enhanced access check to handle Accounting → MYOB/Xero mapping
      const hasAccess =
          commonModules.includes(lowerField) ||
          this.modules.some(
              (m) =>
          ...
          (
              // Allow MYOB and Xero when Accounting module is active
              this.modules.includes("Accounting") &&
              (
                  (this.accountingServices?.toLowerCase() === "myob" && lowerField === "myob") ||
                  (this.accountingServices?.toLowerCase() === "xero" && lowerField === "xero") ||
                  (lowerField === "accounting") // still allow plain Accounting
              )
          );
