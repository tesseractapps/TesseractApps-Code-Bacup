   ...
   // @track isICtUserInViewForm=true;
    ...
    async handleSubmit(event) {
       ...
       fields.Facility__c=this.selctedMultipleFcailityValues[0];
        ...
        // if (this.staffId && fields.Status__c === false) {
        //     let preferredName = (fields.Nickname__c || '').trim();
        //     let firstName = fields.Name || '';
        //     let lastName = fields.Last_Name__c || '';

        //     this.staffname = preferredName 
        //         ? preferredName
        //         : `${firstName} ${lastName}`.trim();
        //     this.checkShiftsAndProceed(fields);
        //     return;
        // }
