  ...
  if (!this.openFromTask) {
    ...
    switch (moduleName) {
      ...
      case "Support Participants":
        ...
        this.handleSubmenuClick(event);
        this.updateBreadcrumb("Support Coordinator", "Support Participants");
      break;
      case "Support Tasks":
        this.supportCoordinatormoduleflag = true;
      ...
      case "Support Providers":
        ...
        this.handleSubmenuClick(event);
        this.updateBreadcrumb("Support Coordinator", "Support Providers");
      break;
      case "Support Notes":
        this.supportCoordinatormoduleflag = true;
        this.supportNotesflag = true;
        this.handleSubmenuClick(event);
        this.updateBreadcrumb("Support Coordinator", "Support Notes");
      break;
      case "Support Billing":
        this.supportCoordinatormoduleflag = true;
        this.supportBillingflag = true;
        this.handleSubmenuClick(event);
        this.updateBreadcrumb("Support Coordinator", "Support Billing");
      break;
