                  ...
                  unAssignedList({ shiftWithStaffId: this.ShiftwithStafftoApexId })
                    .then((result) => {
                      ...
                      if (result && result.length > 0) {
                        ...
                        this.serviceTypeIdFromShift = result[0].Service_Type__c;
                    ...
                    .then((response) => {
                      ...
                      if (response) {
                        ...
                        this.servicePlan =
                          this.TotalFunds.find((opt) => opt.Id === this.ServiceTypeIdInParticipant)?.Plan_Type__c || "";
                      ...
                      if (catLogResult) {
                        ...
                        this.serviceGroupName = catalogueData.map((rec) => {
                          ...
                          if (
                            ...
                            // ✅ Pull from junction maps using the record Id
                            amountVal = catLogResult.clientJunctionMapAmount[rec.Id] || 0;
                            nameVal = catLogResult.clientJunctionMapName[rec.Id] || rec.Support_Item_Name__c;
                          } else {
                            // ✅ Normal case → use state field from catalogue record
                            amountVal = rec[stateField] || 0;
                            nameVal = rec.Support_Item_Name__c;
                  ...
                  if (exceededServices.length > 0) {
                    ...
                    if (
                      ...
                      if( this.addShiftData.AddShiftStatus== 'Unassigned'){
                            ...
                            console.log("finalAddShiftData IN UNASSIGNED  " +JSON.stringify(this.finalAddShiftData));
