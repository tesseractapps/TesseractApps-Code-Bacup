...
export default class FacilityDocument extends LightningElement {
    ...
    categoryClassMap = {
        'Professional Development': 'cat-Policy',
        'Induction': 'cat-Policy',
        'Safety': 'cat-Policy',
        'Clinical Skills': 'cat-Policy',
        'Behaviour Support': 'cat-Policy',
        'Emergency Management': 'cat-Policy',
        'Human Rights & Ethics': 'cat-Policy',
        'Specialized Care': 'cat-Policy',
        'Technology & Systems': 'cat-Policy',
        'Policy Awareness': 'cat-Policy',
        'Cultural Competency': 'cat-Policy'
    };
