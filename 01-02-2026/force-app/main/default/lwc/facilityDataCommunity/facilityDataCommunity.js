...
//import getNDISServiceLineItem from '@salesforce/apex/FacilityController.getNDISServiceLineItem';
...
// @wire(getNDISServiceLineItem, { ServiceDate: '$serviceDate' })
// wiredCatalogue({ data, error }) {
//     if (data) {
//         console.log('Apex records:', JSON.stringify(data, null, 2));
 
//         // 1️⃣ Store full dataset
//         this.allCatalogs = data;
 
//         // 2️⃣ Build Service Type dropdown
...
//         this.serviceTypeOptions = [...uniqueNames].map(name => ({
//             label: name,
//             value: name
//         }));
 
//         // 3️⃣ AUTO-SELECT 0th SERVICE TYPE
//         if (this.serviceTypeOptions.length > 0) {
//             this.selectedServiceType = this.serviceTypeOptions[0].value;
 
//             // 4️⃣ FILTER BASED ON 0th ELEMENT
...
// applyCatlogFilters() {
//     const stateField = this.province ? `${this.province}__c` : null;
//     console.log('State field:', stateField);

//     this.filteredCatalogs = this.allCatalogs
//         .filter(rec => rec.Name === this.selectedServiceType)
//         .map(rec => {
//             return {
//                 ...rec,

//                 // ✅ THIS IS THE KEY LINE
//                 Amount: stateField && rec[stateField] != null
//                     ? rec[stateField]
//                     : null
//             };
//         });
