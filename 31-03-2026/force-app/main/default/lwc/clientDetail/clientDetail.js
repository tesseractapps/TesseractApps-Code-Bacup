  ...
  @track contactList = [
      {
          ...
          contactNumber: '',
          email: '',
          contactType: 'Guardian', // NEW FIELD
          notify:false,
   ...
   // this.contactList = this.contactList1;
    this.contactList = this.contactList.map((c, index, arr) => {
        ...
        return {
            ...
            firstNamePlaceholder: isGuardian ? '* Enter Name' : 'Enter Name',
            lastNamePlaceholder: isGuardian ? '* Enter Name' : 'Enter Name',
            phonePlaceholder: isGuardian ? '* Enter Number' : 'Enter Number',
            emailPlaceholder: isGuardian ? '* Enter Email' : 'Enter Email',
