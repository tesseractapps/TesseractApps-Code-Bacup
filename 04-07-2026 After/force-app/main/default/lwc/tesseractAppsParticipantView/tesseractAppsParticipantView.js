 ...
 this.displayParticipantDropDown=false
    ...
    getAddShiftDataById({ shiftId: this.shiftStaffId }).then(async (result) => {
      ...
      this.addShiftData = {
        ...
        AddShiftDuration:result.shiftwithstaffdata.Add_Shift__r.Break__c =='30'? result.shiftwithstaffdata.Add_Shift__r.Duration__c +  0.5 :result.shiftwithstaffdata.Add_Shift__r.Duration__c,
