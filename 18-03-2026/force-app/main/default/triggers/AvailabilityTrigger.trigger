trigger AvailabilityTrigger on Availability__c (before insert, before update,after insert,after update,after delete) {
   ...
   if (Trigger.isAfter && Trigger.isDelete) {
        AvailabilityTrigger.handleDelete(Trigger.old);
    }
