...
export default class OnBoarding extends LightningElement {
    ...
    async handleCreateRecords() {
      ...
      // ✅ Validate User Type only (Role is auto-assigned)
      ...
      if (missingTypeIds.length) {
          ...
          this.toast('Missing data', 'User Type is required for all selected rows.', 'error');
          return;
      }
      ...
      // ✅ Build payload with auto-assigned role
      const payload = targetRows.map(r => {
          ...
          if (finalUserType === 'NDIS Participant') {
