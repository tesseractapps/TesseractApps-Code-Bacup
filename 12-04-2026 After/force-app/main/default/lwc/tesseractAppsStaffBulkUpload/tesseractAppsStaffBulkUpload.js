...
export default class TesseractAppsUserManagement extends LightningElement {
    ...
    handleDownloadTemplate(event){
        ...
        if(this.typeOfUser=='NDIS'){
            const fileUrl = '/resource/NDIS_Staff_Template_Upload';  // Update the file URL if necessary
    ...
    handleInstructions(event){
        ...
        if(this.typeOfUser=='NDIS'){
            const fileUrl = '/resource/Staff_Bulk_Upload_Instructions_For_NDIS_Users';  // Update the file URL if necessary
            window.open(fileUrl, '_blank');
    ...
    parseCSV(data) {
        ...
        let requiredHeaders = [
            ...
            'AddressCountry', 'ManagementFee', 'Frequency'
        ];
