...
export default class TesseractAppsAccountingSalesEntry extends LightningElement {
  ...
  //  @track entryType; 
   ...
   // @track entryOptions=[{label:'Purchases',value:'Purchases'},{label:'Sales',value:'Sales'}];
    ...
    //     // Work from full dataset
    //     let result = [...this.records];

    //     if (searchValue) {
    //         result = result.filter((rec) => {
    //             const name = rec.Name ? rec.Name.toLowerCase() : '';
    ...
    //     // Update filtered + pagination values
    ...
    //     // Show/hide pagination as needed
    ...
    if (searchValue) {
        result = result.filter((rec) => {
            ...
            // UPDATED — supports $, commas, decimals
            ...
            return (
                ...
                description.includes(searchValue) ||
                ledgerItem.includes(searchValue) ||
                gst.includes(searchKey) ||        // UPDATED
                amount.includes(searchKey) ||     // UPDATED
                date.includes(searchValue)
            );
        });
    }
