...
@wire(getClientById, { recordId: '$participantId' })
  wiredClient(result) {
    ...
    if (data) {
        ...
        this.Nationality = this.clientData[0].Preferred_Nationality__c;
        this.selectedLangs = this.clientData[0].Preferred_Languages__c;
        this.refreshValues();
        /* this.Languages = this.clientData[0].Preferred_Languages__c; */
        console.log('this.Nationality  >>'+ this.Nationality);
        console.log('Languages Name >>'+ this.Languages);
