...
export default class TesseractAppsUserManagement extends LightningElement {
    ...
    handleDownloadTemplate(event){
        ...
        if(this.typeOfUser=='NDIS'){
            const fileUrl = '/resource/User_Template';
    ...
    handleFinalSubmit() {
        ...
        // Remove Languages + Nationality for ICT user type
        if (this.typeOfUser === 'ICT') {
        ...
        // 🔥 STEP 1 — VALIDATE ROWS AND UPDATE ProcessedStatus
        this.tableData = this.tableData.map(user => {
            ...
            if (user.isSelected && user.ProcessedStatus !== 'Success ✅') {
                ...
                // 2️⃣ Skip ABN/TFN validation if already has missing fields error
        ...
        // STOP HERE IF INVALID ROWS FOUND
        ...
        // 🔥 STEP 2 — FORMAT VALID RECORDS & SUBMIT
        try {
