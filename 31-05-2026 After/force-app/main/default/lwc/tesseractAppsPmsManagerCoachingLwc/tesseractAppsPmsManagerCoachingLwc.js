            ...
            .then(result => {
                ...
                const mappedData = sessions.map(rec => {
                  ...
                  //  const employeeCount = children.length;
                    ...
                    const isCreatedByHR = rec.isCreatedByHR__c === true;
                    const isFinalized = (rec.Is_Manager_Finalized__c === true) && rec.Is_HR_Submitted__c === false;

                    const isPending =( rec.isCreatedByRc__c === true && rec.isScheduledCoaching__c === true) || rec.isCreatedByHR__c === true;
                    ...
                    const isHrOnly = isCreatedByHR && type === 'HRs Only coaching';
