...
wiredServiceList(result) {
 ...
 async  handleLinkParticipants() {
    ...
    handleServiceStaffchange(event) {
        ...
        console.log('this.partcipantIdList ' + JSON.stringify(this.partcipantIdList));
        this.pageNumber = 1;/* 
...
handleInvoiceParticipantChange(event) {
    ...
    async generateBase64Data() {
        ...
        // doc.addImage(this.orgLogo, 'PNG', 20, 5, 10, 10, );
            ...
            doc.setFontSize(12);
            doc.text(orgName.toUpperCase(), 10, 25);  
           ...
           console.log('616');
            //if (this.accountingService === 'Tesseract System') {
                ...
                doc.setFont("Roboto-Bold", "bold");
                doc.setFontSize(12);
                doc.text("ABN: "+ abn, 10, 30);
                doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
        
            
                doc.setFontSize(10);
                doc.text(street +",", 10,35 );
                doc.text(cityLine, 10, 40);
                doc.text("Contact: "+ phone, 10, 45);
        ...
        // doc.text("Invoice Number", 150, 24);
           ...
           // const newDate = arr[2]+'/'+arr[1]+'/'+arr[0];      
            doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
            doc.setFontSize(10);
            doc.text("Date Issued: "+serviceDate, 158, 35);
            doc.setFont("Roboto-VariableFont_wdth,wght", "normal");
            doc.setFontSize(10);
    ...
    typeof window.jspdf?.jsPDF?.API?.autoTable
            ...
            doc.autoTable({
               ...
               // head: [["Support Item","Description", "Qty", "Rate", "Tax", "Amount"]],
                head: [["Support Item No","Support Item Name", "Qty", "Rate", "Tax", "Amount"]],
                body: result,
                theme: "plain",
                margin: { left: 10 },
