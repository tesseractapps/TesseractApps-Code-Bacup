...
firstName = '';
lastName = '';
selectedGender = '';      // combobox
phoneNumber = '';
email = '';               // prefilled + disabled
dateOfBirth = '';

// --- Employment ---
selectedRole = null;      // prefilled + disabled
selectedUserType = '';    // separate from role if you want
StaffFacility = '';       // combobox value (id or name)
hourlyRate = '';
taxFileNumber = '';
selectedTaxFree = '';     // combobox
startDate = '';
status = 'Inactive';              // toggle -> we'll set 'Active'/'Inactive'
...
// UI / config
isUserTypeDisabled = true;   // your template uses disabled={isUserTypeDisabled}
errorMessage = '';
...
async handleUserCreation() {
  ...
  try {
    ...
    const employment = {
      ...
      hourlyRate: String(this.hourlyRate ?? ''),    // keep as string for JSON
...
validateInputs() {
  ...
  // Validate lightning-input and lightning-combobox
