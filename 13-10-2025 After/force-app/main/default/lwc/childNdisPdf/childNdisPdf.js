      ...
      if(parseFloat(this.currentRecordPdf[0].staffpayrollData.Working_Hours__c) > 0 ){     
        ...
        if(this.currentRecordPdf[0].staffpayrollData.Gross_Salary__c==undefined){
           ...
           doc.text(dollarUSLocale.format(this.currentRecordPdf[0].staffpayrollData.Current_Salary_Wages_YTD__c.toFixed(2)), 179, 158-parseInt(positionOFHourRows));
            ...
            doc.setDrawColor(229,229,229);
            doc.setFillColor(229, 229, 229);
            doc.rect(10, 160-parseInt(positionOFHourRows), 190, 6,"FD");
            doc.setFont("roboto", "bold");
         ...
         if(this.currentRecordPdf[0].staffpayrollData.Pre_Tax_One_Value__c >0 || this.currentRecordPdf[0].staffpayrollData.Pre_Tax_Two_Value__c >0
             ...
             || this.currentRecordPdf[0].staffpayrollData.Pre_Tax_Five_Value__c >0){
                 ...
                 doc.setDrawColor(229,229,229);
                 doc.setFillColor(229, 229, 229);
                 doc.rect(10, 204-parseInt(positionOfRows)-parseInt(positionOFHourRows), 190, 6,"FD"); 
                ...
                if(this.currentRecordPdf[0].staffpayrollData.Current_Pre_Tax_YTD__c==undefined){
                 ...
                 doc.setFillColor(229, 229, 229);
                 doc.setFont("roboto", "bold");
                 doc.rect(10, 221-parseInt(positionOfRows)-parseInt(positionOFHourRows), 190, 6,"FD"); 
                 ...
                 doc.setFont("roboto", "bold");
                 doc.rect(10, 246-parseInt(positionOfRows)-parseInt(positionOFHourRows), 190, 6,"FD"); 
                ...
                doc.rect(10, 272-parseInt(positionOfRows)-parseInt(positionOFHourRows), 190, 6,"FD"); //265
               doc.text("Gross Salary",12,276-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                 ...
                 doc.setDrawColor(229,229,229);
                 doc.setFillColor(229, 229, 229);
                 doc.rect(10, 280-parseInt(positionOfRows)-parseInt(positionOFHourRows), 190, 6,"FD");//273 maheswari code end
                ...
                doc.setFillColor(229, 229, 229);
                doc.setFont("roboto", "bold");
                doc.rect(10, 170-parseInt(positionOFHourRows), 190, 6,"FD"); 
                ...
                doc.setFillColor(235, 235, 235);
                doc.setFont("roboto", "bold");
                doc.rect(10, 194-parseInt(positionOFHourRows), 190, 6,"FD"); 
                ...
                doc.setDrawColor(229,229,229);
                doc.setFillColor(229, 229, 229);
                doc.rect(10, 219-parseInt(positionOFHourRows), 190, 6,"FD"); //265
                ...
                doc.setDrawColor(229,229,229);
                doc.setFillColor(229, 229, 229);
                doc.rect(10, 227-parseInt(positionOFHourRows), 190, 6,"FD");//273 maheswari code end
