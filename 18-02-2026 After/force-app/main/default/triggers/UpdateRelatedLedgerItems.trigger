trigger UpdateRelatedLedgerItems on Accounting_Journal_Entry__c (after insert, after update, after delete, after undelete) {
   ...
   if (Trigger.isAfter && (Trigger.isInsert || Trigger.isUpdate || Trigger.isUndelete)) {
        AccountingChildEntryHandler.updateRelatedChildLedgerItems(Trigger.new);
    }

    // For after delete → use Trigger.old
   if (Trigger.isAfter && Trigger.isDelete) {
        AccountingChildEntryHandler.updateRelatedChildLedgerItems(Trigger.old);
    }
  ...
  /* if (Trigger.isAfter && (Trigger.isUpdate || Trigger.isInsert)) {
     ...
     if (Trigger.isAfter && (Trigger.isUpdate || Trigger.isInsert)) {
        AccountingChildEntryHandler.updateRelatedChildRecords(Trigger.new);
    } 
}