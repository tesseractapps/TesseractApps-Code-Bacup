   ...
   @track  participants = [ ];
    ...
    async loadUpcomingEvents() {
        ...
        try {
            ...
            // 🔹 Map to dashboard-friendly structure
            this.allDayEvents = sorted.map(t => {
                const mappedEvent = {
                    id: t.Id,
                    title: t.Notes_Type__c,
            ...
            console.log('All Day Events:', this.allDayEvents);

            // 🔹 First 3 only
            this.upcomingEvents = this.allDayEvents;

            console.log('Upcoming Events Assigned:', this.upcomingEvents);
        ...
        try {
            ...
            this.participants = data.map(p => {
                ...
                return {
                    ...
                    budget: `$${p.Total_Plan_Budget__c || 0}`,
