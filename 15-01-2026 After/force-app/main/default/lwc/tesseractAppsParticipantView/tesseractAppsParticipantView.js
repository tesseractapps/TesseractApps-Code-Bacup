   ...
   formatDisplayDate(dateString) {
    ...
    async hanleProceedWithShiftCompliance(){
     ...
     hanleRecurShiftsCreation(){
        this.unavailableTemplate=false;
            const recurrenceDates = this.AddShiftRecurringCheckboxValue == true ? this.recurrenceDatesList  : [this.finalAddShiftData.shiftDetails.AddShiftStartDate];
       console.log(
         " recurrence date list " + JSON.stringify(this.recurrenceDatesList)
       );
