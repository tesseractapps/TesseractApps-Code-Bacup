      ...
      getCatalogueData({
        ...
        .then((result) => {
          ...
          this.serviceGroupName = catalogueData.map((rec) => {
            return {
              ...rec,
              amount: (this.otherThanNdis == true || (this.otherThanNdis == false &&  result.catalogueData[0].Name=='Miscellaneous' ))? result.amount ||0 : rec[stateField] || 0 // dynamically pick amount using stateField
            };
          });
          ...
          if ((this.otherThanNdis == true && this.fundOption[0].label == "Other") ) {
                            ...
                            unAssignedList({ shiftWithStaffId: this.ShiftwithStafftoApexId })
                              .then((result) => {
                                ...
                                if (result && result.length > 0) {
                                  ...
                                  return getClientFunds({ clientId: this.serviceParticipant });
                                }
                              })
                              .then((response) => {
                                  ...
                                  this.serviceGroupName = catalogueData.map((rec) => ({
                                    ...
                                    amount:
                                      ...
                                      (this.otherThanNdis === false &&
                                        catalogueData[0].Name === "Miscellaneous")
                                        ? catLogResult.amount || 0
                                        : rec[stateField] || 0,
