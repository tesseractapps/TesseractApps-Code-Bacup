   ...
   // @track isPermissionView=false;
    ...
    cards = [
            ...
            },
            {
                ...
                description: 'Review and Finalise Assessments',
                subText: 'Review employee performance assessments and finalise reviews',
               // badgeText: '',
                badgeClass: '',
    ...
    console.log('Checking plan on HR PMS load...');

    try {
        const isStart = await isStartPlan();

        // 🔴 BLOCK MODULE COMPLETELY
        if (isStart) {
            console.log('🚫 Start plan → block HR PMS');
        ...
        switch (fieldName) {
            ...
            case 'competencyWeight':
                if (Number(value) < 0) {
                    ...
                    this.showToast(
                        'Error',
                        'Competency Weight cannot be negative',
                        'error'
                    );
    ...
    handleBackFromManagerCoaching() {
        this.isHome = true;
        this.isCoachingManagement = false;
    }
    handleBackFromHrCoaching() {
        this.isHome = true;
        this.isCoachingManagement = false;
    }
