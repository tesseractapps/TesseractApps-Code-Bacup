...
export default class Repository extends NavigationMixin(LightningElement) {
    ...
    fetchInitialRepositoryData() {
        ...
        fetchRepositoryData({ organisationId: this.orgId })
            .then((data) => {
   ...
   /*  userTypeOption = [
    ...
    handleSubmitPermissions(event){
        ...
        insertSecurityRecord({ repositoryId: this.selectedRowId,selectedUsers: this.selectedUserIds, isView: this.isViewFlag}).then(() => {
