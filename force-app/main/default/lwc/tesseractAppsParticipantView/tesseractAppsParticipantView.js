      ...
      staffSlistOnSelection(){
        ...
        //  StaffRole.push(this.addShiftData.AddShiftRole);
          ...
          console.log('stafff Roles1 '+JSON.stringify(StaffRole));
             ...
             console.log('staff combo boxx in create edit list'+JSON.stringify(response))
              this.staffComboBoxOptions= response.map(rec => {
                this.StaffHourlyRates[rec.Id] = { "staffHoulryRate": rec };
                return {
    ...
    handleOpenParticipantShiftView(event){
     ...
     let holiday= event.currentTarget.dataset.isholiday;
        ...
        // this.addShiftData.AddShiftFacilityValue=this.finalSelectedFacilities[0].value;
          this.addShiftData.AddShiftFacilityValue=event.currentTarget.dataset.facvalue;
          console.log('AddShiftFacilityValue '+this.addShiftData.AddShiftFacilityValue);
...
console.log('updated rate rows  11'+JSON.stringify(this.rateRows));
  ...
  this.isDisableSaveButton = hasError;
    ...
    this.isShowSpinner = true;
      assignShifts({ startDate: this.startDate, endDate: this.endDate,AutoScheduleParameters :JSON.stringify(this.rows),facList:this.facIdlist }).then(result=>{
        console.log('Result  ==>',JSON.stringify(result));
