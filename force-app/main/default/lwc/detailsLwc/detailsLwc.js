...
export default class DetailsLwc extends NavigationMixin(LightningElement) {
    ...
    handleUnavailableUntilChange(event) {
        ...
        const selectedDate = new Date(this.unavailableUntilDate);
        selectedDate.setHours(0, 0, 0, 0);
        this.isSaveDisabled = false;
        if (selectedDate < today) {
            this.unavailableUntilDate = null; // Clear the invalid date
    ...
    handlesavebuttonforParticipantPopup() {
        ...
        console.log('isAvailable: ' + this.isAvailable + ' isUnavailable: ' + this.isUnavailable + ' Client Id: ' + this.recordId + ' medications: ' + this.medications + ' allergies: ' + this.allergies + ' notes: ' + this.notes + 'Date: ' + this.unavailableUntilDate);
        const today = new Date();
