...
handleSaveAccount(companyId) {
    ...
    handleDownloadTemplate(event){
        const fileUrl = '/resource/Import_AccountList_Template';  // Update the file URL if necessary
        window.open(fileUrl, '_blank');

    }
    handleInstructions(event){
        const fileUrl = '/resource/Instructions_for_Import_Account_List';  // Update the file URL if necessary
        window.open(fileUrl, '_blank');
    }
    @track uploadedFiles;
