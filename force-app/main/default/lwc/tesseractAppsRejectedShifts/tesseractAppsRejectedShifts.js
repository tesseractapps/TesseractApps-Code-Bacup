...
export default class TesseractAppsRejectedShifts extends LightningElement {
 ...
 @wire(getRejectedShifts, { datePicker: '$wiredDateParams.datePicker', orgId: '$wiredDateParams.orgId' })
            ...
            if (result.data) {
                this.rejectedShifts = result.data;
    ...
    this.rejectedShifts.forEach(shift => {
        ...
        if (header) {
            header.shifts.push({
                ...
                staffName1: shift.Staff__r?.NameToDisplay__c || 'Unknown',
...
AllocateShift(event){
 ...
 handleAllocateToggle(event) {
    ...
    .then(() => {
        ...
        this.confirMationMessage('Success', 'Shift successfully allocated', 'success');
