      ...
      for (var i = 0; i < this.finalStaffData.length; i++) { 
        ...
        for (var j = 0; j < this.allocationList.length; j++) {
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day0 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime1'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day1 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime2'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day2 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime3'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day3 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime4'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day4 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime5'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day5 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime6'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if (this.finalStaffData[i].Id == this.allocationList[j].Staff__c && (this.finalStaffData[i].Day6 == this.allocationList[j].Start_Date__c)) {
            ...
            this.finalStaffData[i]['startTime7'] =this.allocationList[j].Shift_time_AMPM__c;
          ...
          if(staffWithDuplicate.includes(datesstring)){
            duplicateFound=true 
              ...
              this.dispatchEvent(
                new ShowToastEvent({
                  title: 'Error',
                  message: 'Please enter Start Date, End Date,Date Issued and  Description ',
                  variant: 'Error'
                })
              );
              this.accountRecList=[];
       ...
       if (availableSpace > tableHeight + 40) { // Check if there's enough space to fit both the table and additional text
           ...
           margin: { left: 10, right: 10 },
             ...
             //  body:ictTable
               ...
               didParseCell: function (data) {
                const totalRowIndex = ictTable.length - 1;  // Last row is Total Hours
                if (data.row.index === totalRowIndex && (data.column.index === 0 || data.column.index === 7)) {
                    data.cell.styles.font = 'Roboto-Bold';  // or 'times' or any font that supports bold
                    data.cell.styles.fontStyle = 'bold';
                }
            }
             });
