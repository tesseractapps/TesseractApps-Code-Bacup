...
export default class TesseractAppsPublishShift extends LightningElement {
 ...
 /*  @track EOIvalue; */
   ...
   /*  const bubbleContainer = this.template.querySelector(
    ...
    getFullFundList(){
         getClientFunds({ clientId: this.addShiftData.AddShiftParticipantValue,shiftName:this.addShiftData.AddShiftTypeName })
                .then((response) => {
    ...
    serviceFundSelection() {
        ...
        .then((result) => {
            ...
            console.log('catalogueData.editedCatalogName ==> '+result.editedCatalogName);
                ...
                this.serviceNameDisplay = (result.editedCatalogName ? result.editedCatalogName : this.serviceGroupName[0].Name) + ' - ' + formattedAmount;
