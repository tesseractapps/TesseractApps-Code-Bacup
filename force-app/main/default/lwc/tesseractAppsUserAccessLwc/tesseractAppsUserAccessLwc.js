...
export default class TesseractAppsUserAccessLwc extends LightningElement {
    ...
    moduleMap = {
        'NDIS Org Admin': ['Admin', 'Human Resources', 'Incident Register', 'Participants', 'Repository', 'Roster Manager', 'Sign In','My Profile','Accounting', 'Access Manager', 'T sign', 'Payroll'],
        ...
        'ICT Admin' : ['Admin', 'Accounting', 'Human Resources',  'ICT Timesheets', 'T sign', 'My Profile', 'Repository', 'Access Manager', 'Payroll'],
