...
export default class TesseractAppsUserAccessLwc extends LightningElement {
    ...
    moduleMap = {
        ...
        'ICT Admin' : ['Admin', 'Payroll', 'Accounting', 'Human Resources',  'ICT Timesheets', 'T sign', 'Incident Register', 'My Profile', 'Repository', 'Access Manager'],
    ...
    handleSearchStaffKeyDown(event) {
        if (event.key === 'Enter') {
            this.searchStaff = event.target.value;
            this.paginateData(); // Your method to process the search
        }
    }
