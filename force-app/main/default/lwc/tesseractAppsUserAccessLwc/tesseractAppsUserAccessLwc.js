   ...
   @wire(getUserTypeValuesfromOrg, { selectedroleValue: '$selectedRole', userId: '$userId' })
        ...
        updatestaffDetails({ userDetails: userData })
            .then(result => {
                ...
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Success',
                        message: 'User details updated. Changes will be applied within 3 hours.',
                        variant: 'success'
                    })
                );
            })
    ...
    handleConfirmResetPassword(event) {
        ...
        resetPortalPassword({ ResetpasswordUserId: selectedUserId })
            .then((result) => {
                    this.showToast('Success', 'Password setup link will be sent to your email within 3 hours.', 'success');
                this.resetPasswordModal = false;
            })
            .catch((error) => {
