           ...
           // let formattedAmount = "$0.00";
            ...
            this.hierarchyData = sortedData.map(accountList => ({
                ...
                categories: accountList.categories.map(category => ({
                    ...
                    expanded: true,
                    iconName: 'utility:chevronright',
                    amount:   this.formatAmount(category.categoryAmount ||0),
                    subCategories: category.subCategories.map(subCategory => ({
                        ...subCategory,
                        expanded: true,
                        iconName: 'utility:chevronright',
                        amount:   this.formatAmount(subCategory.subCategoryAmount ||0),
                        ledgers: subCategory.ledgers.map(ledger => ({
                            ...ledger,
                            expanded: true,
                            iconName: 'utility:chevronright',
                            amount:   this.formatAmount(ledger.ledgerAmount ||0),
