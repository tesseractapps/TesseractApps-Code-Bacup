...
export default class ChildNdisPdf extends LightningElement {
    ...
    generatePayroll() {        
        ...
        doc.text("SALARY & WAGES",10,95);
        doc.setFont("roboto", "bold");
        doc.text("RATE",122,95);
        doc.setFont("roboto", "");
       ...
       if(this.currentRecordPdf[0].staffpayrollData.General_Shift_Hour__c > 0 ){
        doc.text("General Shift Hours",10,101-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.General_Shift_Hour__c).toString(), 97, 101-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(generalShiftrate).toString(), 122, 101-parseInt(positionOFHourRows));
       ...
       if(this.currentRecordPdf[0].staffpayrollData.Afternoon_shift_Hours__c > 0 ){ 
        ...
        doc.text("Afternoon Shift Hours",10,107-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Afternoon_shift_Hours__c).toString(), 97, 107-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(AfterNoonRate).toString(), 122, 107-parseInt(positionOFHourRows));
       }else{
        positionOFHourRows +=6;
       }
      if(this.currentRecordPdf[0].staffpayrollData.Night_Shift_Hours__c > 0 ){ 
        doc.text("Night  Shift Hours",10,113-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Night_Shift_Hours__c).toString(), 97, 113-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(nightShiftRate).toString(), 122,113-parseInt(positionOFHourRows) );
      ...
      if(this.currentRecordPdf[0].staffpayrollData.Saturday_hours__c> 0 ){ 
        doc.text("Saturday Shift Hours",10,119-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Saturday_hours__c).toString(), 97, 119-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(saturdayRate).toString(), 122, 119-parseInt(positionOFHourRows));
     ...
     if(this.currentRecordPdf[0].staffpayrollData.Sunday_hours__c > 0 ){ 
        doc.text("Sunday Shift Hours",10,125-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Sunday_hours__c).toString(), 97, 125-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(saturdayRate).toString(), 122, 125-parseInt(positionOFHourRows));
     }else{
        positionOFHourRows +=6;
      }
      
      if(this.currentRecordPdf[0].staffpayrollData.Public_Holiday__c> 0 ){ 
        doc.text("Public Holiday Hours",10,130-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Public_Holiday__c).toString(), 97, 130-parseInt(positionOFHourRows));
        ...
        doc.text(dollarUSLocale.format(holidayRate).toString(), 122, 130-parseInt(positionOFHourRows));
     }else{
        positionOFHourRows +=6;
      }

      if(this.currentRecordPdf[0].staffpayrollData.Sleepover_Hours__c > 0 ){  
        doc.text("Sleepover Shift Hours",10,137-parseInt(positionOFHourRows));
        doc.text((this.currentRecordPdf[0].staffpayrollData.Sleepover_Hours__c).toString(), 97, 137-parseInt(positionOFHourRows));
        doc.text(" --", 122, 137-parseInt(positionOFHourRows));
      }else{
        positionOFHourRows +=6;
       }
        ...
        if(this.currentRecordPdf[0].staffpayrollData.Gross_Salary__c==undefined){
         ...
         if(this.currentRecordPdf[0].staffpayrollData.Pre_Tax_One_Value__c >0 || this.currentRecordPdf[0].staffpayrollData.Pre_Tax_Two_Value__c >0
             ...
             || this.currentRecordPdf[0].staffpayrollData.Pre_Tax_Five_Value__c >0){
                 ...
                 doc.setDrawColor(229,229,229);
                 doc.setFillColor(229, 229, 229);
                 doc.rect(10, 202-parseInt(positionOfRows)-parseInt(positionOFHourRows), 185, 6,"FD"); 
                 doc.text("TOTAL",122,206-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                 if(this.currentRecordPdf[0].staffpayrollData.Pre_tax_values__c==undefined){
                     doc.text("$0.00", 144, 206-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                }else{
                    doc.text(dollarUSLocale.format(this.currentRecordPdf[0].staffpayrollData.Pre_tax_values__c.toFixed(2)), 144, 206-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                }
                if(this.currentRecordPdf[0].staffpayrollData.Current_Pre_Tax_YTD__c==undefined){
                 doc.text("$0.00", 179, 206-parseInt(positionOfRows));
                 }else{
                     doc.text(dollarUSLocale.format(this.currentRecordPdf[0].staffpayrollData.Current_Pre_Tax_YTD__c.toFixed(2)), 179, 206-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                 }
                 doc.setFont("roboto", "bold");
                 doc.text("TAX",10,212-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                 doc.text("PAYG",10,216-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                 doc.setFont("roboto", "");
               ...
               doc.text("Gross Salary",12,276-parseInt(positionOfRows)-parseInt(positionOFHourRows));
                ...
                if(this.currentRecordPdf[0].staffpayrollData.Voluntary_Contribution__c){
                    if(this.currentRecordPdf[0].staffpayrollData.Voluntary_Contribution__c =='Fixed'){  
                        doc.text("Voluntary Superannuation-Fixed",10,191-parseInt(positionOFHourRows)-parseInt(positionOFHourRows));
