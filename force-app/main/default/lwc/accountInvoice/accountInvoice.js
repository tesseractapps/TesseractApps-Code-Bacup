...
export default class AccountInvoice extends LightningElement {
    ...
    @track allStatusOptions =[{label:'Draft',value:'Draft'},{label:'Issued',value:'Issued'}];    //   ,{label:'Received',value:'Received'}
    @track taxCodes = [
   ...
   //@track selectedRowIdTax;
    ...
    //         return;
    //     }
    //     // if (!this.salesEntryList.accountList ) {
    //     //     this.showToast('Error', 'Please select the AccountList.', 'error');
    //     //     return;
    //     // }
    //     // if (!this.salesEntryList.tax ) {
    //     //     this.showToast('Error', 'Please select the Tax.', 'error');
    //     //     return;
    //     // }
    ...
    try {
        ...
        if (isUpdate) {
            this.showToast('Success', 'Purchase record updated successfully', 'success');
        } else {
            this.salesEntry.Status = 'Draft';
