...
@track  apiFieldMap = {
    ...
    handleDownloadPDF() {
        try {
            ...
            doc.text(`${this.StaffName1} - Shift Summary`, 14, 20);
            ...
            const headers = [
                ...
                "End Time", "Break", "Duration", "Mileage", "Expense", "Variance"
            ];
            ...
            // AutoTable rendering with row height and page breaking
            doc.autoTable({
                head: [headers],
                body: data,
                startY: 35,
                styles: {
                    fontSize: 7.5,
                    cellPadding: { top: 4, bottom: 4, left: 1.5, right: 1.5 } // Controls row height
                },
                headStyles: {
                ...
                columnStyles: {
                    0: { cellWidth: 16 },   // Date
                    1: { cellWidth: 16 },   // Shift
                    2: { cellWidth: 25 },   // Services
                    3: { cellWidth: 25 },   // Facility
                    4: { cellWidth: 16 },   // Start Time
                    5: { cellWidth: 16 },   // End Time
                    6: { cellWidth: 12 },   // Break
                    7: { cellWidth: 16 },   // Duration
                    8: { cellWidth: 16 },   // Mileage
                    9: { cellWidth: 18 },   // Expense
                    10: { cellWidth: 16 }   // Variance
                },
            ...
            // Ensure table is done rendering before calculating finalY
            let finalY = doc.autoTable.previous.finalY + 10;
            const pageHeight = doc.internal.pageSize.height;

            // If there's not enough room for summary, add a new page
            ...
            doc.text(`Total Shifts: ${totalShifts}`, 14, finalY + 8);
            doc.text(`Total Duration: ${totalDuration.toFixed(2)} hours`, 14, finalY + 16);
            doc.text(`Total Expenses: $${totalExpenses.toFixed(2)}`, 14, finalY + 24);
