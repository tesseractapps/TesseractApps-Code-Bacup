  ...
  convertTo24HourFormat(timeStr) {
    ...
    handleDownloadCSV() {
        try {
            ...
            console.log("📅 Export Start:", this.ExportStartDate, "| Export End:", this.ExportEndDate);
            ...
            console.log("📝 this.selectedStaffShiftsforPDF:", JSON.stringify(this.selectedStaffShiftsforPDF));

            // Data Rows
            const dataRows = (this.selectedStaffShiftsforPDF || []).map((shift, index) => {
    ...
    handleDownloadClickfortimesheet() {
        ...
        this.processedSummaries.forEach(staff => {
            ...
            while (current <= end) {
                ...
                if (shift) {
                    console.log(`   📅 ${dateStr} → Hours: ${shift.hours}, Mileage: ${shift.mileage}, Expense: ${shift.expense}, Sleepover: ${shift.sleepoverHours}, Variance: ${shift.variance}`);
            ...
            console.log("   📊 Totals → Hours:", totalHours, "Mileage:", totalMileage, "Expense:", totalExpense, "Sleepover:", totalSleepover, "Variance:", totalVariance);
    ...
    handleDownloadPDFFortimesheet() {
        ...
        dateChunks.forEach((chunk, chunkIndex) => {
            ...
            doc.autoTable({
                ...
                margin: 5,
                theme: 'grid',
                styles: { fontSize: 7, halign: 'center', valign: 'middle', minCellHeight: 15 },
                headStyles: { fillColor: [41, 128, 185], textColor: [255, 255, 255], fontSize: 8, halign: 'center' },
