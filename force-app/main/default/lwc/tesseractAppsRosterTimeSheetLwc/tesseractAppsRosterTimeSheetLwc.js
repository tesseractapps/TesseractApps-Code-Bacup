    ...
    fetchOrganizationDetails() {
        organizationDetails()
            .then(response => {
                ...
                this.otherThanNDISUser = org.Other_than_NDIS_User__c;
                this.pageSize = 10;
  ...
  hideHandleLocation(){
    ...
    handleCheckClick(event) {
        ...
        getMismatchedShifts({ staffId: staffId, weekStart: start, weekEnd: end })
            .then(shifts => {
                console.log('getMismatchedShifts >>', getMismatchedShifts);
                const filteredShifts = (shifts || []).filter(shift => {
                    ...
                    return {
                        ...
                        participantName: (shift.Services_and_Support_Plans__r?.[0]?.Client__r?.First_Name__c || '') +
                                         ' ' +
