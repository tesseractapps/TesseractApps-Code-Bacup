...
/*   handleeditClose() {
    this.roleEmploymentData = {};//manendra added for role memory storage
    this.currentEmploymentRoleKey = '';  //manendra added for role memory storage
    this.staffEditFlag = false;
    this.cardFlag = false;
    this.adminFlag = true;
    this.visible = true;
   ...
   handleDelete(event) {
    ...
    fetchFacility(facId) {        
      // getfacilityById({ facId: facId }).then(result => {
        ...
        return getfacilityById({ facId: facId }).then(result => {
        if (result) {
          ...
          console.log('Awards Flags =>', {
          type: this.typeOfService,
          schads: this.isSchadsAwards,
          nursing: this.isNursingAwards,
          childCare: this.isChildCareAwards,
          fixed: this.isFixedcategory
      });
...
//       this.fetchFacility(selectedFacilityValue);
  ...
  //manendra end for role memory storage
      /* close dropdown */
