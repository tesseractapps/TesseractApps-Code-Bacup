...
get triggerClass() {
    return `slds-combobox__form-element slds-input-has-icon slds-input-has-icon_right${
        this.disabled ? ' slds-is-disabled slds-combobox__input-value' : ''
    }`;
}

get inputClass() {
    return `slds-input slds-combobox__input ${
        this.disabled ? 'slds-input_faux fix-slds-input_faux slds-is-disabled slds-combobox__input-value combobox-input-disabled' : ''
    }`;
}
}