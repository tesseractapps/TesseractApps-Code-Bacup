...
resetTsignContext() {
  ...
  setModuleFlags() {
    ...
    // this.SmartReports = this.modules.includes("Smart Reports");
  ...
  if (!this.openFromTask) {
    ...
    switch (moduleName) {
      ...
      case "Chatter":
        ...
        break;
      case "Smart Reports":
        this.smartReportsFlag = true;
        this.handleMenuClick(event);
        this.updateBreadcrumb("Smart Reports");
        break;
      case "CMS":
        this.CMSFlag = true;
        this.handleMenuClick(event);
  ...
  handleNavigation(event) {
    ...
    switch (notification) {
      ...
      case "Congratulations on receiving a award.":
        this.awardFlag = true;
        this.simulateClick('.menu-link[data-field="My Profile"]');
        this.simulateClick('.menu-link[data-field="MP Awards & Recognition"]');
        break;
...
handleLeaveTaskConsumed() {
  ...
  // triggerAccountingNdisPayrollSettings() {
  //   const fakeEvent = {
  //     currentTarget: {
  //       dataset: {
  //         field: "NDIS Payroll Settings", // submenu
  //         content: "Accounting"          // parent module
  //       }
  //     }
  //   };
