    ...
    if(this.whatId){
      ...
      this.dispatchEvent(new CustomEvent('clearstaffid', {
       ...
       // this.noRecordsFlag=true;
        ...
        window.addEventListener('resize', () => this.setPageSizeByZoomAndScreen());
    }
...
handleResize() {
    ...
    disconnectedCallback() {
        unsubscribe(this.subscription, () => {
         ...
         window.removeEventListener('resize', () => this.setPageSizeByZoomAndScreen());
    }
