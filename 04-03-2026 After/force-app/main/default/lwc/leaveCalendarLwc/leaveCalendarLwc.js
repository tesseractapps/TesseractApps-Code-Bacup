...
if (status === 'Approved') {
    ...
    cell.approvedClass = 'calendar-pill calendar-pill_approved';

} else if (status === 'Rejected') {
    cell.typeRejected = true;
    cell.rejectedClass = 'calendar-pill calendar-pill_rejected';

} else if (status === 'Cancelled') {
    cell.typeCancelled = true;
    cell.cancelledClass = 'calendar-pill calendar-pill_cancelled';

} else if (status === 'Withdraw') {
    cell.typeWithdrawn = true;
    cell.withdrawnClass = 'calendar-pill calendar-pill_withdrawn';

} else if (status === 'Requested') {
    cell.typeRequested = true;
    cell.requestedClass = 'calendar-pill calendar-pill_requested';
}
