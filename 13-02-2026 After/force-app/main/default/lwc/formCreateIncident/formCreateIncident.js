...
handleMandatoryKeydown = (e) => {
  ...
  // }
    ...
    try {
      ...
      const awsMeta = await this.uploadFormJsonToAws(layoutObj, "DraftIR");
...
async uploadFormJsonToAws(finalRows, folderType) {
  if (!folderType) {
  throw new Error(
...
const key = `CustomisableIR/${this.orgid}/${dateStr}/${folderType}/${safeTitle}.json`;
