...
/* -------------------------
   ...
   ------------------------- */
    ...
    async  handleCheckboxChange(event) {
        ...
        if (!isEntityValid && !this.accountingServiceflag ) {
            return;
        }
        ...
        if (hasCompanyMissing && !this.accountingServiceflag ) {
            this.disableBool = true;
        ...
        handleAddToXero(event) {
            ...
            if (this.accountingService === 'MYOB') {
                ...
                .then((result) => {
                    ...
                    console.log('this.recordsBulk >>>>', JSON.stringify(this.recordsBulk))
