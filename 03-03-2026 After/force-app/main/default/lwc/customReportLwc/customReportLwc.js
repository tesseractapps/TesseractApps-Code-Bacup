...
export default class CustomReportLwc extends LightningElement {
    ...
    async connectedCallback() {
        ...
        this.selectedFacilityIdforgenerated = storedFacilityLabel;
    ...
    downloadUnderOverEfficiencyCSV() {
        ...
        this.createExportLog('Detailed Export (CSV)', this.reportTypeValue);
    }
    ...
    downloadUnderOverEfficiencyPDF() {
        ...
        this.createExportLog('Detailed Export (PDF)', this.reportTypeValue);
    }
    ...
    exportExcelFromTemplate(templateKeys, rows) {
        ...
        this.createExportLog('Summary Export (CSV)', this.reportTypeValue);
    }
    ...
    exportPdfFromTemplate(templateKeys, rows) {
        ...
        this.createExportLog('Summary Export (PDF)', this.reportTypeValue);        
    }
